...
function test()
{
 ...
 //puts desired location and temperature into T and L
  alert(l);
  alert(t);
  alert(r);
   //getResults(l, t, r);
...
function getResults(location, temperature)
{
  alert("getResults activates");
  // using data, calculate what should be worn.
  var weather="sunny";
  var accessory="scarf";
  var top="jacket";
  var bottom="skirt";
  var endstring="It is " + weather + ". You should take "+ accessory +". You should wear a "+ top + " and a " + bottom + ".";
  document.body.innerHTML=endstring;
  alert (endstring);
}
